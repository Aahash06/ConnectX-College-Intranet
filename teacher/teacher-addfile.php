...
<?php include('../common/teacher-sidebar.php') ?>  
    <main role="main" class="col-xl-10 col-lg-9 col-md-8 ml-sm-auto px-md-4 mb-2 w-100 page-content-index">
        ...
        <html>
            ...
            <body>
                <div style="border:1px solid; border-radius: 6px; padding:2em; margin-bottom:2em; width:100%;">
                    <h5>All Files</h5>
                    <button><a href="javascript:location.reload(true)"><i style="color:black">refresh</i></button>
                    <div style="display:flex; flex-direction:column">
                    <?php 
                        // List files in uploads folder
                        $files = glob('../uploads/teacher-upload/*');
                        // Loop through files
                        foreach($files as $file){
                            // Get file name
                            $fileName = basename($file);
                            // Print file link
                            echo '<a href="../uploads/teacher-upload/'.$fileName.'">'.$fileName.'</a><br>';
                        }
                    ?>
                    </div>
                </div>
                <form method="post" enctype="multipart/form-data">
                    ...
                    <input type="submit" value="upload" name="file-submit-button">
                    <!-- <input type="submit" value="delete" name="file-delete-button"> -->
                </form>
            </body>
        </html>
        ...
        if(isset($_POST['file-submit-button'])){
            $target_dir = "../uploads/teacher-upload/";

		...
		<nav id="sidebarMenu" class="">
			<div class="col-xl-2 col-lg-3 col-md-4 sidebar position-fixed border-right">
				...
				<ul class="nav flex-column">
					<li class="nav-item">
						<a class="nav-link" href="../common/common-addfile.php">
						<span data-feather="file"></span>
						<i class="fa fa-duotone fa-folder-open" aria-hidden="true"></i>Test My Files
						</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="../student/student-addfile.php">
						<span data-feather="file"></span>
						<i class="fa fa-duotone fa-folder-open" aria-hidden="true"></i>My Files
						</a>
					</li>
					<li class="nav-item">

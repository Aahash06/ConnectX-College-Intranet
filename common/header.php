...
<html>
<head>
	<title>Home-FACULTY OF ENGINEERING AND TECHNOLOGY</title>
...
<nav class="navbar navbar-expand-lg navbar-dark header-back sticky-top header-navbar-fonts">
	<a class="navbar-brand d-flex align-items-center" href="index.php">
		<img src="images/icon1.png" class="logo-image" width="50" height="50">
		<h3 class="text-light text-uppercase ml-2">FACULTY OF ENGINEERING AND TECHNOLOGY</h3>
	</a>
